...
public class SmartSwitchBase extends DeviceBase implements DeviceBaseInterface {
    protected SmartSwitchActivity activity;
    ...
    public SmartSwitchBase(Baseactivity baseactivity) {
        super(baseactivity);
        title = "智能开关";
        activity = (SmartSwitchActivity) baseactivity;
        switchEvent();
    }
     ...
     * @param commen
     */
    public void showMsg(Switch commen) {
        ...
        public void onReceive(Context context, Intent intent) {
            if (IsRegisterMpush) {
                if (intent.getAction().equals(GlobalPrefrence.DEVICEDATA)) {
                    ...
                    Switch gas = JSON.parseObject(string.toString(), Switch.class);
