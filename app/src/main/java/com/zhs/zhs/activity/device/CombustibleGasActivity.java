...
public class CombustibleGasActivity extends Baseactivity {
    ...
    String areaId = "";
    Device device;
    CombustibleBase deviceBase;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_combustible_gas);
        ...
        deviceBase = DeviceContext.getCombustibleBaseInstance(type, this);
