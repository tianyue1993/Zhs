...
public class SmartPlugBase extends DeviceBase implements DeviceBaseInterface {
    protected SmartPlugActivity activity;
    ...
    public SmartPlugBase(Baseactivity baseactivity) {
        super(baseactivity);
        title = "智能插座";
        activity = (SmartPlugActivity) baseactivity;
        switchEvent();
    }
     ...
     * @param commen
     */
    public void showMsg(SmartPlug commen) {
        ...
        public void onReceive(Context context, Intent intent) {
            if (IsRegisterMpush) {
                if (intent.getAction().equals(GlobalPrefrence.DEVICEDATA)) {
                    ...
                    SmartPlug gas = JSON.parseObject(string.toString(), SmartPlug.class);
