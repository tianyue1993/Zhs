...
import com.zhs.zhs.activity.device.DoorAlarmActivity;
...
public class DoorAlarmBase extends DeviceBase implements DeviceBaseInterface {
    protected DoorAlarmActivity activity;
    ...
    public DoorAlarmBase(Baseactivity baseactivity) {
        super(baseactivity);
        activity = (DoorAlarmActivity) baseactivity;
        switchEvent();
    }
        ...
        public void onReceive(Context context, Intent intent) {
            if (IsRegisterMpush) {
                if (intent.getAction().equals(GlobalPrefrence.DEVICEDATA)) {
                    ...
                    GlassShock electric = JSON.parseObject(string.toString(), GlassShock.class);
