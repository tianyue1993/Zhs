...
package com.zhs.zhs.devicempush;
...
import com.zhs.zhs.BuildConfig;
 ...
 * @author ohun@live.cn
 */
public final class MPushDeviceService extends Service implements ClientListener {
    ...
    private static PendingIntent getOperation(Context context) {
        Intent intent = new Intent(context, MPushDeviceService.class);
